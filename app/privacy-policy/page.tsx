export default function PrivacyPolicyPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 py-12 prose prose-neutral dark:prose-invert">
      ...
      <p>We only collect personal data that is necessary for providing and improving the website’s services. This includes:</p>
      <ul>
        <li>
      ...
      <p>We process your data for the following purposes, based on the following legal grounds:</p>
      <ul>
        <li>
      ...
      <p>We may use privacy-friendly third-party services that do not track individual users, such as:</p>
      <ul>
